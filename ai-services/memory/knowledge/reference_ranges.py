...
REFERENCE_RANGES = {
    ...
    "MCV": {
        ...
        "unit": "fL",
        "newborn": {"min": 96, "max": 108},
        "infant": {"min": 72, "max": 88},
        "child": {"min": 75, "max": 95},
        "adolescent": {"min": 78, "max": 100},
        "adult": {"min": 80, "max": 100},
        "elderly": {"min": 80, "max": 100},
    ...
    "MCH": {
        ...
        "unit": "pg",
        "newborn": {"min": 27, "max": 33},
        "infant": {"min": 25, "max": 33},
        "child": {"min": 25, "max": 33},
        "adolescent": {"min": 26, "max": 34},
        "adult": {"min": 27, "max": 34},
        "elderly": {"min": 27, "max": 34},
        "normal": {"min": 27, "max": 34},
        "description": "每个红细胞含血红蛋白量，降低提示低血红蛋白性贫血"
    },
    "MCHC": {
        "name": "平均红细胞血红蛋白浓度 (Mean Corpuscular Hemoglobin Concentration)",
        "unit": "g/L",
        "newborn": {"min": 300, "max": 360},
        "infant": {"min": 300, "max": 360},
        "child": {"min": 300, "max": 360},
        "adolescent": {"min": 310, "max": 360},
        "adult": {"min": 320, "max": 360},
        "elderly": {"min": 320, "max": 360},
    ...
    "RDW": {
        ...
        "unit": "%",
        "newborn": {"min": 11.5, "max": 14.5},
        "infant": {"min": 11.5, "max": 14.5},
        "child": {"min": 11.5, "max": 14.5},
        "adolescent": {"min": 11.5, "max": 14.5},
        "adult": {"min": 11.5, "max": 14.5},
        "elderly": {"min": 11.5, "max": 14.5},
    ...
    "RDW-CV": {
        ...
        "elderly": {"min": 11.5, "max": 14.5},
        "normal": {"min": 11.5, "max": 14.5},
        "description": "反映红细胞大小变异系数"
    },
    "RDW-SD": {
        "name": "红细胞分布宽度-SD",
        "unit": "fL",
        "newborn": {"min": 35, "max": 56},
        "infant": {"min": 35, "max": 56},
        "child": {"min": 35, "max": 56},
        "adolescent": {"min": 35, "max": 56},
        "adult": {"min": 35, "max": 56},
        "elderly": {"min": 35, "max": 56},
        "normal": {"min": 35, "max": 56},
        "description": "反映红细胞大小标准差"
    },
    "NRBC": {
    ...
    "NE": {
        ...
        "unit": "%",
        "newborn": {"min": 50, "max": 70},
        "infant": {"min": 30, "max": 60},
        "child": {"min": 30, "max": 60},
        "adolescent": {"min": 40, "max": 75},
        "adult": {"min": 40, "max": 75},
        "elderly": {"min": 40, "max": 75},
    ...
    "LY": {
        ...
        "unit": "%",
        "newborn": {"min": 20, "max": 40},
        "infant": {"min": 40, "max": 70},
        "child": {"min": 30, "max": 60},
        "adolescent": {"min": 20, "max": 50},
        "adult": {"min": 20, "max": 50},
        "elderly": {"min": 20, "max": 50},
    ...
    "MO": {
        "name": "单核细胞 (Monocytes)",
        "unit": "%",
        "newborn": {"min": 3, "max": 10},
        "infant": {"min": 3, "max": 10},
        "child": {"min": 3, "max": 10},
        "adolescent": {"min": 3, "max": 10},
        "adult": {"min": 3, "max": 10},
        "elderly": {"min": 3, "max": 10},
        "normal": {"min": 3, "max": 10},
    ...
    "EO": {
        ...
        "unit": "%",
        "newborn": {"min": 0.4, "max": 8.0},
        "infant": {"min": 0.4, "max": 8.0},
        "child": {"min": 0.4, "max": 8.0},
        "adolescent": {"min": 0.4, "max": 8.0},
        "adult": {"min": 0.4, "max": 8.0},
        "elderly": {"min": 0.4, "max": 8.0},
        "normal": {"min": 0.4, "max": 8.0},
    ...
    "NEUT#": {
        "name": "中性粒细胞数",
        "unit": "×10⁹/L",
        "newborn": {"min": 3.0, "max": 12.0},
        "infant": {"min": 1.5, "max": 8.0},
        "child": {"min": 1.5, "max": 8.0},
        "adolescent": {"min": 1.8, "max": 6.3},
        "adult": {"min": 1.8, "max": 6.3},
        "elderly": {"min": 1.8, "max": 6.3},
        "normal": {"min": 1.8, "max": 6.3},
        "critical_low": 0.5,
        "description": "低于0.5时感染风险显著增加"
    },
    "LYMPH#": {
        "name": "淋巴细胞数",
        "unit": "×10⁹/L",
        "newborn": {"min": 2.0, "max": 10.0},
        "infant": {"min": 2.0, "max": 10.0},
        "child": {"min": 1.5, "max": 8.0},
        "adolescent": {"min": 1.1, "max": 3.2},
        "adult": {"min": 1.1, "max": 3.2},
        "elderly": {"min": 1.0, "max": 3.0},
        "normal": {"min": 1.1, "max": 3.2},
        "description": "免疫功能指标"
    },
    "MONO#": {
        "name": "单核细胞数",
        "unit": "×10⁹/L",
        "newborn": {"min": 0.1, "max": 0.6},
        "infant": {"min": 0.1, "max": 0.6},
        "child": {"min": 0.1, "max": 0.6},
        "adolescent": {"min": 0.1, "max": 0.6},
        "adult": {"min": 0.1, "max": 0.6},
        "elderly": {"min": 0.1, "max": 0.6},
        "normal": {"min": 0.1, "max": 0.6},
        "description": "慢性感染或炎症时升高"
    },
    "EO#": {
        "name": "嗜酸性粒细胞数",
        "unit": "×10⁹/L",
        "newborn": {"min": 0.02, "max": 0.52},
        "infant": {"min": 0.02, "max": 0.52},
        "child": {"min": 0.02, "max": 0.52},
        "adolescent": {"min": 0.02, "max": 0.52},
        "adult": {"min": 0.02, "max": 0.52},
        "elderly": {"min": 0.02, "max": 0.52},
        "normal": {"min": 0.02, "max": 0.52},
        "description": "过敏或寄生虫感染时升高"
    },
    "BASO#": {
        "name": "嗜碱性粒细胞数",
        "unit": "×10⁹/L",
        "newborn": {"min": 0, "max": 0.06},
        "infant": {"min": 0, "max": 0.06},
        "child": {"min": 0, "max": 0.06},
        "adolescent": {"min": 0, "max": 0.06},
        "adult": {"min": 0, "max": 0.06},
        "elderly": {"min": 0, "max": 0.06},
        "normal": {"min": 0, "max": 0.06},
        "description": "过敏反应时升高"
    },
    ...
    "MPV": {
        ...
        "unit": "fL",
        "newborn": {"min": 7.0, "max": 11.0},
        "infant": {"min": 7.0, "max": 11.0},
        "child": {"min": 7.0, "max": 11.0},
        "adolescent": {"min": 7.0, "max": 11.0},
        "adult": {"min": 7.0, "max": 11.0},
        "elderly": {"min": 7.0, "max": 11.0},
        "normal": {"min": 7.0, "max": 11.0},
        "description": "反映血小板大小，升高与出血倾向相关，降低与脾脏疾病相关"
    },
    "PCT": {
        "name": "血小板比容 (Plateletcrit)",
        "unit": "%",
        "newborn": {"min": 0.108, "max": 0.282},
        "infant": {"min": 0.108, "max": 0.282},
        "child": {"min": 0.108, "max": 0.282},
        "adolescent": {"min": 0.108, "max": 0.282},
        "adult": {"min": 0.108, "max": 0.282},
        "elderly": {"min": 0.108, "max": 0.282},
    ...
    "PDW": {
        ...
        "unit": "fL",
        "newborn": {"min": 9.6, "max": 15.2},
        "infant": {"min": 9.6, "max": 15.2},
        "child": {"min": 9.6, "max": 15.2},
        "adolescent": {"min": 9.6, "max": 15.2},
        "adult": {"min": 9.6, "max": 15.2},
        "elderly": {"min": 9.6, "max": 15.2},
        "normal": {"min": 9.6, "max": 15.2},
        "description": "反映血小板体积不均匀程度，升高提示血小板异常或造血功能异常"
    },
    "P-LCR": {
        "name": "大血小板比率",
        "unit": "%",
        "newborn": {"min": 13, "max": 43},
        "infant": {"min": 13, "max": 43},
        "child": {"min": 13, "max": 43},
        "adolescent": {"min": 13, "max": 43},
        "adult": {"min": 13, "max": 43},
        "elderly": {"min": 13, "max": 43},
        "normal": {"min": 13, "max": 43},
        "description": "大血小板比例，升高提示血小板生成活跃"
    },
    "P-LCC": {
        "name": "大血小板数目",
        "unit": "×10⁹/L",
        "newborn": {"min": 30, "max": 90},
        "infant": {"min": 30, "max": 90},
        "child": {"min": 30, "max": 90},
        "adolescent": {"min": 30, "max": 90},
        "adult": {"min": 30, "max": 90},
        "elderly": {"min": 30, "max": 90},
        "normal": {"min": 30, "max": 90},
        "description": "大血小板数目，降低提示血小板生成减少"
    },
