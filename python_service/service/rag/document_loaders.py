...
# 知识数据目录：harness/memory/knowledge/data/
_KNOWLEDGE_DATA_DIR = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "..", "..", "harness", "memory", "knowledge", "data"
)

MAIN_DOCS_DIR = os.path.join(_KNOWLEDGE_DATA_DIR, "main_agent_docs")
DEPT_DOCS_DIR = os.path.join(_KNOWLEDGE_DATA_DIR, "dept_agent_docs")
MEDICAL_DOCS_DIR = os.path.join(_KNOWLEDGE_DATA_DIR, "medical_docs")
